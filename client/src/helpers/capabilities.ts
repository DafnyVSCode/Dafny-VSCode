...
import { EnvironmentConfig, Config } from "../stringRessources";
...
export default class Capabilities {
    ...
    static config = workspace.getConfiguration(EnvironmentConfig.Dafny);

    static hasSupportedMonoVersion(): boolean {
